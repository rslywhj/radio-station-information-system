  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="稿子" prop="article">
          <el-select v-model="form.article" placeholder="请选择稿件" clearable :style="{ width: '200px' }">
            <el-option
              v-for="(item1,index1) in article"
              :key="index1"
              :label="item1.name"
              :value="item1"
            />
...
<script>
  import {selectBYEdit, addFdjjr, updateFdjjr, selectEdit, selectBroadcast, delFdjjr,selectArticle} from "@/api/date";
    ...
    methods: {
      ...
      viewDetails(day) {
        if (this.rqi.indexOf(day) > -1) {
          ...
          console.log(this.rqineirong[day].articleId)
          console.log("edit"+this.rqineirong[day].edit)
          if (this.rqineirong[day].articleId !== null){
            this.neirong = this.neirong + "<br/>"+"稿件"+
              this.rqineirong[day].articleId
            //todo 等大中的查看稿子，更改为超链接|改写稿子id查title
          }
        }
