...
<script>
  import {updateStatusZ,seeArticles,noUpdateStatusZ} from "@/api/articles";
    ...
    methods: {
      ...
      Tong(scope) {
        ...
        this.$confirm('确认通过这个稿子吗?', '通过提醒', {
          ...
          .then(async () => {
            updateStatusZ(scope.row.articleTitle)
            this.$message({
              type: 'success',
              message: '通过成功'
            })
      ...
      BuTong(scope) {
        ...
        this.$confirm('确认退回这个稿子吗?', '通过提醒', {
          ...
          .then(async () => {
            noUpdateStatusZ(status,scope.row.articleTitle)
            this.$message({
              type: 'success',
              message: '退回成功'
            })
